...
import { IDeletePlaceRequest, placeListResponse } from 'src/app/models/unit-manage';
...
export class DeletePlaceDialogComponent {
  device: placeListResponse;

  @Output() dialogClosed = new EventEmitter<void>();

  constructor(
    private unitService: UnitManageService,
    @Inject(MAT_DIALOG_DATA) public data: placeListResponse
  ) {
    this.device = data;
  };
